(function (a) {
      ...
      g(
        ...
        function (c, f) {
          !1 === c
            ? "undefined" == typeof f
              ? a.on_error(
                  "Instagram Feed: It looks like the profile you are trying to fetch is age restricted.",
                  3
                )
              : ((c = d(a, !0)),
                !1 === c
  ...
  function i(d, e) {
    ...
    if (
      (d.display_profile &&
        "userid" !== d.type &&
        ((g += '<div class="instagram_profile"' + f.profile_container + ">"),
        (g +=
          ...
          ("tag" == d.type
            ? e.name + " tag pic"
            : e.username + " profile pic") +
          '"' +
          f.profile_image +
          (d.lazy_load ? ' loading="lazy"' : "") +
          " />"),
        "tag" == d.type
          ? (g +=
      ...
      if ("undefined" != typeof e.is_private && !0 === e.is_private)
        g +=
          '<p class="instagram_private"><strong>This profile is private</strong></p>';
      else {
        var j =
            "undefined" == typeof k[d.image_size] ? k[640] : k[d.image_size],
          l = (
        ...
        for (var n = 0; n < m; n++) {
          var o,
            ...
            r = c(l[n], e);
          switch (
            (!1 === r && (r = ("userid" == d.type ? "" : d.id) + " image"),
            (r = b(r)),
            l[n].node.__typename)
          ) {
            case "GraphSidecar":
          ...
          (g +=
            ...
            q +
            '"' +
            (d.display_captions ? ' data-caption="' + r + '"' : "") +
            ' class="instagram-' +
            p +
            '" rel="noopener" target="_blank"' +
            f.gallery_image_link +
            ">"),
            (g +=
              "<img" +
              (d.lazy_load ? ' loading="lazy"' : "") +
  ...
  var j = {
    ...
    k = { 150: 0, 240: 1, 320: 2, 480: 3, 640: 4 },
    l = {
      "&": "&amp;",
      "<": "&lt;",
      ">": "&gt;",
  ...
  a.instagramFeed = function (b) {
    ...
    return "" == c.username &&
      ...
      : ("" == c.username
          ? "" == c.tag
            ? "" == c.location
              ? ((c.type = "userid"), (c.id = c.user_id))
              : ((c.type = "location"), (c.id = c.location))
            : ((c.type = "tag"), (c.id = c.tag))
          : ((c.type = "username"), (c.id = c.username)),
        (c.cache_data_key = "instagramFeed_" + c.type + "_" + c.id),
        (c.cache_time_key = c.cache_data_key + "_time"),
        h(c, function (a) {
